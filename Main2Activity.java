...
public class Main2Activity extends AppCompatActivity {
    ...
    private Button list;
    private String time, com,number;
    private EditText ecomment;
    private TimePicker mTimePicker;
    private EditText phoneno;
    String prevtime, prevCom,prevNum;
    private TextView t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Database References
        mDatabase = FirebaseDatabase.getInstance().getReference().child("CodesAcc").child("ttt"); // Pointing to Codes
        ...
        gtoken.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataMap.put("Start time", time);
                dataMap.put("name", com);
                dataMap.put("Phone_no",number);
    ...
    public void invokeAlertremove() {
        ...
        if (prevCom != null && prevtime != null) {
            ...
            a1.setMessage("My Token number is: " + "Ac" + (Integer.parseInt(oldVersion.substring(2)) - 1) + "\n" + "name: " + prevCom + "\n" + "Time Slot: " + prevtime+"\n"+"Contact no:"+prevNum);
    ...
    public void call1(View view) {
        Intent j = new Intent(Main2Activity.this, callactivity.class);
        startActivity(j);
    ...
    public void invokeAlert(){
        ...
        a1.setMessage("Your Token number is "+"Ac" + (Integer.parseInt(oldVersion.substring(2)) - 1));
    ...
    private void getInputData(){
        ...
        prefs.edit().putString("prevNum",prevNum).apply();
