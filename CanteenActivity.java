...
public class CanteenActivity extends AppCompatActivity {
    ...
    private ChildEventListener mChildEventListener = new ChildEventListener() {
        ...
        public void onChildAdded(DataSnapshot dataSnapshot, String s) {
            ...
            oldVersionC = "Cn" + (Integer.parseInt(oldVersionC.substring(2)) + 1);
            currTokenC = oldVersionC;
            mRef.setValue(currTokenC);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Database References
        mDatabase = FirebaseDatabase.getInstance().getReference().child("CodesCn"); // Pointing to Codes
        mRef = FirebaseDatabase.getInstance().getReference("Current TokenCn"); //Pointing to OldVersion
    ...
    public void invokeAlertremove() {
        ...
        if (prevCom != null && prevtime != null) {
            ...
            a1.setMessage("My Token number is: " + oldVersionC + "\n" + "Comments: " + prevCom + "\n" + "Time Slot: " + prevtime);
    ...
    public void invokeAlert() {
        ...
        a1.setMessage("Your Token number is " + oldVersionC);
