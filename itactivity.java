...
public class itactivity extends AppCompatActivity {
        ...
        private ChildEventListener mChildEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                oldVersionT = "It" + (Integer.parseInt(oldVersionT.substring(2)) + 1);
                currTokenT = oldVersionT;
                mRef.setValue(currTokenT);
            }
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            //Database References
            mDatabase = FirebaseDatabase.getInstance().getReference().child("CodesIT"); // Pointing to Codes
            mRef = FirebaseDatabase.getInstance().getReference("Current TokenIT"); //Pointing to OldVersion
        ...
        public void invokeAlertremove() {
            ...
            if (prevCom != null && prevtime != null) {
                ...
                a1.setMessage("My Token number is: " + oldVersionT + "\n" + "Comments: " + prevCom + "\n" + "Time Slot: " + prevtime);
        ...
        public void invokeAlert(){
            ...
            a1.setMessage("Your Token number is "+oldVersionT);
